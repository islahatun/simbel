...
class LaporanPemesananOffline extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['content_overview'] = $this->load->view('laporanPemesananOffline', $data, true);
		$this->load->view('overview', $data);
	}

	public function datalist()
	{
		$list = $this->MListPesananOffline->datalistGroup();
		...
		foreach ($list as $ListPesananOffline) {
			...
			$rtn[] = array(
				...
				'btn_action'            => "<a href='" . base_url('LaporanPemesananOffline/listPesananOffline/' . $ListPesananOffline->id_pelanggan) . "' class='btn btn-sm btn-outline-success' target='blank'> 
	...
	{
		$list = $this->MListPesananOffline->datalistGroupDetail($id);
		$rtn = array();
		$i = 1;
